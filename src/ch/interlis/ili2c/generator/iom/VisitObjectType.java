 ...
 * @author ce
 */
public class VisitObjectType implements Visitor, ObjWriter {
	public void visitObject(Object obj1, VisitorCallback cb) {
		ObjectType obj=(ObjectType)obj1;
	...
	public void writeObject(Writer out, Object obj1, WriterCallback cb)
		...
		ObjectType obj=(ObjectType)obj1;
		String tag=IomGenerator.MODEL+"."+IomGenerator.TOPIC+".ObjectType";
		...
		if(obj.getRef()!=null){
			out.write("<referred REF=\""+cb.encodeOid(cb.getobjid(obj.getRef()))+"\"/>");
		}
		out.write("</"+tag+">");
	}
	public void bootstrapWriteObject(Writer out, Object obj1, WriterCallback cb)
		...
		String tag=tagPrefix+".ObjectType";
		...
		if(obj.getRef()!=null){
			out.write("link=new iom_object(true);"+cb.newline());
			out.write("link->setTag(ParserHandler::getTagId(\""+tagPrefix+".ReferredObjectType"+"\"));"+cb.newline());
			out.write("objref=new iom_objref();"+cb.newline());
			out.write("objref->setOid(X(\""+cb.getobjid(obj.getRef())+"\"));"+cb.newline());
			out.write("link->setLinkEnd(ParserHandler::getTagId(\"objectType\"),obj);"+cb.newline());
