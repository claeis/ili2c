 ...
 * @author ce
 */
public class VisitClassType implements Visitor, ObjWriter {
	public void visitObject(Object obj1, VisitorCallback cb) {
		ClassType obj=(ClassType)obj1;
		...
		while(elei.hasNext()){
			Viewable restrictedTo=(Viewable)elei.next();
			cb.addPendingObject(new ClassTypeRestrictedTo(obj,restrictedTo));
		}
	}
	...
	public void writeObject(Writer out, Object obj1, WriterCallback cb)
		...
		ClassType obj=(ClassType)obj1;
		String tag=IomGenerator.MODEL+"."+IomGenerator.TOPIC+".ClassType";
		...
		out.write("<isStructure>"+cb.encodeBoolean(obj.isStructure())+"</isStructure>");
		out.write("</"+tag+">");
	}
	public void bootstrapWriteObject(Writer out, Object obj1, WriterCallback cb)
		...
		String tag=tagPrefix+".ClassType";
		...
		out.write("obj->setAttrValue(ParserHandler::getTagId(\"isStructure\"),X(\""+cb.encodeBoolean(obj.isStructure())+"\"));"+cb.newline());		
