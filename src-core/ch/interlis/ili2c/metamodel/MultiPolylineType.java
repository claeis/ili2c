...
/** The type which is represented in INTERLIS using the keywords
    <code>DIRECTED MULTIPOLYLINE</code> and <code>MULTIPOLYLINE</code>.
*/
public class MultiPolylineType extends LineType
{
  protected boolean directed = false;

  /** Constructs a new, undirected PolylineType.
  */
  public MultiPolylineType ()
  {
  }


  /** Returns "DIRECTED MULTIPOLYLINE" or "MULTIPOLYLINE", depending
      on whether or not the PolylineType is directed.
  */
  public String toString ()
  {
    if (directed)
      return "DIRECTED MULTIPOLYLINE";
    else
  ...
  */
  void checkTypeExtension (Type wantToExtend)
  {
    ...
    if (!(wantToExtend instanceof MultiPolylineType))
    {
    ...
    {
      if (((MultiPolylineType) wantToExtend).isDirected())
      {
        throw new IllegalArgumentException (
