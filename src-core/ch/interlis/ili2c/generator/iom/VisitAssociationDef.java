 ...
 * @author ce
 */
public class VisitAssociationDef implements Visitor, ObjWriter {
	public void visitObject(Object obj1, VisitorCallback cb) {
		AssociationDef obj=(AssociationDef)obj1;
	...
	public void writeObject(Writer out, Object obj1, WriterCallback cb)
		...
		AssociationDef obj=(AssociationDef)obj1;
		String tag=IomGenerator.MODEL+"."+IomGenerator.TOPIC+".AssociationDef";
		...
		out.write("<isLightweight>"+cb.encodeBoolean(obj.isLightweight())+"</isLightweight>");
