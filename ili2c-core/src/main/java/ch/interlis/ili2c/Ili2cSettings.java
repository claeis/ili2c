...
public class Ili2cSettings extends ch.ehi.basics.settings.Settings {
    ...
    /** env variable with default ilidirs
     */
    public final static String ENV_DEFAULT_ILIDIRS = "DEFAULT_ILIDIRS";
	...
	public static Ili2cSettings load() 
	{
	...
	try{
        ...
        if(ilidirs==null){
            ilidirs=System.getenv(ENV_DEFAULT_ILIDIRS);
            if(ilidirs!=null) {
                userSettings.setIlidirs(ilidirs);
            }else {
